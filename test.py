    ...
    messages = [
        ...
        },
        {
            ...
            "content": f"Organize the following CV text into a structured JSON format containing:\n"
                       ...
                       f"    * 'end_date' (year the degree or qualification was obtained, or 'Non spécifié' if not available),\n"
                       f"    * 'degree' (e.g., Master, Bachelor, or 'Non spécifié' if not provided),\n"
                       f"    * 'field' (e.g., Computer Science, or 'Non spécifié' if not provided),\n"
                       f"    * 'institution' (e.g., University of Lyon, or 'Non spécifié' if not provided),\n"
                       f"    * 'format' (e.g., alternance, or leave empty if not applicable))\n"
