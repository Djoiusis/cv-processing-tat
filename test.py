    ...
    messages = [
        ...
        },
        {
            ...
            "content": f"Organize the following CV text into a structured JSON format containing:\n"
                       ...
                       f"- experience (list of roles with fields:\n"
                       f"    * 'start_date' (start date of the role),\n"
                       f"    * 'end_date' (end date of the role or 'Present' for current roles),\n"
                       f"    * 'company' (name of the company),\n"
                       f"    * 'location' (location of the role, e.g., city, country),\n"
                       f"    * 'position' (job title or position),\n"
                       f"    * 'clients' (optional, if specified),\n"
                       f"    * 'projects': (a list of projects, with each project containing:\n"
                       f"        - 'name': (title of the project or key responsibility area),\n"
                       f"        - 'description': (a summary of the project or responsibility objective, formatted clearly),\n"
                       f"        - 'missions': (a detailed list of tasks or responsibilities, parsed from bullet points, numbered lists, or similar))\n"
